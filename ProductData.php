	...
	<div class="modal-dialog">
		<div class="modal-content">
			<form method="post" action="#savedata">
				...
				<input type="number" class="form-control" name="masuk" id="exampleInputEmail1" aria-describedby="emailHelp"  onkeypress="return onlyNumberKey(event)" required />
				</div>

				<!-- Keluar-->
				<div class="mb-3">
				<label for="exampleInputEmail1" class="form-label">Keluar</label>
				<input type="number" class="form-control" name="keluar" id="exampleInputEmail1" aria-describedby="emailHelp"  onkeypress="return onlyNumberKey(event)" required />
				</div>
